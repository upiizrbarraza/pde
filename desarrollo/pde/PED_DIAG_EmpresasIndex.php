...
<script type="text/javascript" src="EmpresasDetalle.js"></script>
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Padr&oacute;n Empresas</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12" align="center">
            <h4 class="spaced">Padr&oacute;n de Empresas</h4>
          </div>
          </br>
          <div class="col-md-12" id="mostrar"  align="center" style="overflow-y:scroll;height:400px">   
            ...
            while ($registro=mysql_fetch_array($resultado)) {
              echo"<tbody>";
                echo"<tr>";
                  ...
                  //$det ="detalles(".$registro['idEmpresa'].")";
                  echo"<td>";
                    echo"<a href='PED_DIAG_EmpresasDetalles.php?idempresa=".$registro['idEmpresa']."'><button type='submit' class='btn btn-primary'><i class='fa fa-plus fa-lg'></i>&nbsp;&nbsp;&nbsp;Detalles</button></a>";
                    echo"</br>";
                    echo"</br>";
                    ...
                    echo"</br>";
                    echo"</br>";
                    echo"<a href='PED_DIAG_EmpresaActualiza.php?idempresa=".$registro['idEmpresa']."'><button type='button' class='btn btn-info'><i class='fa fa-external-link fa-lg'></i>&nbsp;&nbsp;&nbsp;Actualizar</button></a>";
                  echo"</td>";
                echo"</tr>";                
              echo"</tbody>";
          ...
          <div class="col-md-12" align="center">  
            ...
            <a href="php/loginEmpresa.php"><button type="button" class="btn btn-success"><i class="fa fa-plus-square fa-lg"></i>&nbsp;&nbsp;&nbsp;Agregar Mi empresa</button></a>              
          </div>
