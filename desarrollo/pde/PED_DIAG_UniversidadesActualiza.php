...
<script type="text/javascript" src="UniversidadesActualiza.js"></script>
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Actualización Universidad</li>
          </ol>
        </div>
      </div>
    </div>
...
<?php
              ...
              $id = $_GET['idUniversidad'];

              echo"<input type='hidden' id='universidad' value='".$id."'/>";
            ...
            <div class="col-md-12" align="center" style="text-align:center">
              ...
              <button id="actualizar" type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal"><i class="fa fa-floppy-o fa-lg"></i>&nbsp;&nbsp;&nbsp;Actualizar</button>
