...
<script type="text/javascript" src="EmpresasActualiza.js"></script>
        ...
        <div class="row">
          ...
          <form >
            <div class="col-md-12" style="text-align:center">
              <h4 class="spaced">Registro de Empresas</h4>   
            </div>
            <div class="col-md-6" align="rights">  
              ...
              echo"<input type='hidden' id='empresa' value='".$id."'/>";

              $consulta = "SELECT * FROM empresas WHERE idEmpresa = '".$id."'";
              ...
              while($registro = mysql_fetch_array($valor)){
                ...
                echo"<input type='text' value='' placeholder='".$registro['nombre']."' maxlength='100' class='form-control' name='nombre_empresa' id='nombre_empresa'>";
            
                echo"<label>Dirección*</label>";
                echo"<input type='text' value='' placeholder='".$registro['direccion']."' maxlength='100' class='form-control' name='direccion_empresa' id='direccion_empresa'>";

                echo"<label>Telefonos</label>";
                echo"<input type='text' value='' placeholder='".$registro['telefono1']."' maxlength='100' class='form-control' name='telefono1_empresa' id='telefono1_empresa'>";
                echo"<input type='text' value='' placeholder='".$registro['telefono2']."' maxlength='100' class='form-control' name='telefono2_empresa' id='telefono2_empresa'>";

                echo"<label>Contacto*</label>";
                echo"<input type='text' value='' placeholder='".$registro['contacto']."' maxlength='100' class='form-control' name='contacto' id='contacto'>";

                echo"<label>Correo*</label>"; 
                echo"<input type='email' value='' placeholder='".$registro['correo']."' maxlength='100' class='form-control' name='correo_empresa' id='correo_empresa'>";
              
                echo"<label>Sito Web</label>";
                echo"<input type='text' placeholder='".$registro['sitioWeb']."' maxlength='100' class='form-control' name='web_empresa' id='web_empresa'>";
                ...
                echo"<input type='text' placeholder='".$registro['numeroEmpleados']."' maxlength='100' class='form-control' name='num_empleados' id='num_empleados'>";
                

                echo"<label>Antiguedad</label></br>";
                
              
                echo"<input type='radio' name='ant1' id='ant1' value='1'>Menos de un año &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                echo"<input type='radio' name='ant2' id='ant2' value='2'>Entre 2 a 3 años &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                echo"<input type='radio' name='ant3' id='ant3' value='3'>M&aacute;s de 3 años";
          ...
          //<!-- Start Colum 2 -->
                ...
                echo"<textarea  rows='3' class='form-control' placeholder = '".$registro['vacantes']."' name='vacantes' id='vacantes' style='resize:none;overflow:auto;'></textarea>";
              


                echo"<label>Descrip&oacute; de servicios*</label>";
              
                echo"<textarea  rows='3' class='form-control'  placeholder='".$registro['descripcion']."' name='descripcion' id='descripcion' style='resize:none;overflow:auto;'></textarea>";
                ...
                echo"<textarea  rows='3' class='form-control' placeholder='".$registro['productos']."' name='productos' id='productos' style='resize:none;overflow:auto;'></textarea>";
              
                echo"<label>Cargar logotipo*</label>";
                echo"<input type='file' value='Logo' id='logo' class='btn btn-primary' data-loading-text='Loading...' >";
              }
            ?>          
            </div>
            <div class="col-md-12" align="center" style="text-align:center">
              ...
              <button type="button" class="btn btn-danger" ><i class="fa fa-times fa-lg"></i>&nbsp;&nbsp;&nbsp;Elimianr empresa</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="PED_DIAG_Login.php"><button type="button" class="btn btn-warning"><i class="fa fa-reply fa-lg"></i>&nbsp;&nbsp;&nbsp;Regresar</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;              
              <button type="button" id="Actualizar" class="btn btn-success" data-toggle="modal" data-target="#myModal"><i class="fa fa-floppy-o fa-lg"></i>&nbsp;&nbsp;&nbsp;Actualizar</button>
