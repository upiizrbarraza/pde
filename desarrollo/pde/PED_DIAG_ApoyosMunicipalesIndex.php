...
<!-- <script type="text/javascript" src="js/apoyosAjax.js"></script> -->
      ...
      <div class="container">
        <div class="row">
          <form action="" type="post">
            ...
            <a href="php/login.php"><button type="button" class="btn btn-info"><i class="fa fa-cogs fa-lg"></i>&nbsp;&nbsp;&nbsp;Entrar al PDE</button>
              </br>
              </br>   
            </div>
            <div class="col-md-12" style="text-align:center">
              <h4 class="spaced">Apoyos Municipales</h4>
              </br>
              </br>   
            </div>
          <!-- Start Colum 1 -->
            <div class="col-md-4" align="center" id="nomApoyo">
            <?php

  //Conexión a la base de datos
  include 'php/conexion.php';
  //Query a la tabla apoyos
  $query = mysql_query("SELECT * FROM apoyos WHERE status = 1");

  //Sólo se mostrarán los apoyos con status 1
  while($row=mysql_fetch_array($query)){

      echo '<a href="PED_DIAG_ApoyosMunicipalesDetalles.php?idApoyo='.$row['idApoyo'].' style="width:80%" id="apoyoLink"> <img src="'.$row['logotipo'].'" alt="Nombre"> </a>';   
        echo '<h5 class="spaced">'.$row['nombre'].'</h5></br>';
  }
?>                  
            </div>        
          </form>          
