    ...
    <div id="content" class="content full">
      <div class="container">
        <div class="row">          
          ...
          <!-- Start Colum 1 -->  
            <div class="col-md-6"  align="center">          
              ...
              <div class="col-md-8 col-md-offset-3" align="center" style="color:#000000;">  
        ...
        <form action="#" type="post">
          ...
          <div class="col-md-6"  align="center">
            <div class="col-md-8 col-md-offset-3" align="center" style="color:#000000;">  
              <h4 class="spaced">Inciar Sesi&oacute;n</h4></br>
              <label>Usuario</label>
              <input type="text"  maxlength="100" class="form-control" name="user" id="user" size="10" required>
            
              <label>Contraseña</label>
              <input type="password" maxlength="100" class="form-control" name="pass" id="pass" size="10" required>              
            
              </br>
              <button type="submit" class="btn btn-success"><i class="fa fa-unlock fa-lg"></i>&nbsp;&nbsp;&nbsp;Iniciar</button>  
              </br>
              </br>
              </br>
            </div>                      
