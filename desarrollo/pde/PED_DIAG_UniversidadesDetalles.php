...
<div class="body"> 
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Universidad Detalles</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="page-header">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
           <p class="drop-caps secondary">U</br></br><h1>niversidad</h1></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <?php 
             include 'php/conexion.php';
              ...
              while ($registro=mysql_fetch_array($respuesta)){
                ...
                $t1 = $registro['telefono1'];
                $t2 = $registro['telefono2'];
                $correo = $registro['correo'];
                $sitio = $registro['sitioWeb'];
                $como = $registro['comoLlegar'];
              }
        ...
        <div class="row">
          ...
          <!-- Start Colum 1 -->
            ...
            <div class="col-md-12" style="text-align:center" align="center">
              ...
              <h4 class="spaced">Detalles de universidad</h4></br>

              <?php
               
               echo"<a href='http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER' data-rel='prettyPhoto' class='media-box' style='width:30%'> <img src='".$logo."' alt='No Carga'> </a>"; 
              //echo "<a href='http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER' data-rel='prettyPhoto' class='media-box' style='width:30%''> <img src='".$logo."' alt=''> </a>";
              ?>
              </br>
              
             
              <div class="col-md-8" style="text-align:left" align="left">
              <label>Carreras*</label>
              <?php       
              echo '<textarea  rows="3" class="form-control" name="carreras" id="carreras" style="resize:none;overflow:auto;" disabled>'.$carreras.'</textarea>';
              ...
              <?php              
              echo "<a href='PED_DIAG_CarrerasDetalle.php?idUniversidad=".$id."'><button type='submit' class='btn btn-primary'>Ver Carreras</button></a></br></br>";
              ?>
              </div>
            ...
            echo '<textarea  rows="3" class="form-control" name="mision" value="<?php echo $mision?>" id="mision" style="resize:none;overflow:auto;" disabled>'.$mision.'</textarea>';
            ?> 

              <label>Dirección*</label>
              <input type="text" value="<?php echo $direccion?>" maxlength="100" class="form-control" name="direccion_universidad" id="direccion_universidad" disabled>

              <label>Telefonos</label>
              <input type="text" value="<?php echo $t1?>" maxlength="100" class="form-control" name="telefono1_universidad" id="telefono1_universidad" disabled>

              <input type="text" value="<?php echo $t2?>" maxlength="100" class="form-control" name="telefono2_universidad" id="telefono2_universidad" disabled>
              
              <label>Correo*</label>
              <input type="email" value="<?php echo $correo?>" maxlength="100" class="form-control" name="correo_universidad" id="correo_universidad" disabled>
          ...
          <!-- Start Colum 2 -->
            <div class="col-md-6" align="rights">              
             ...
             <?php
             echo '<textarea  rows="3" class="form-control"name="vision" id="vision" style="resize:none;overflow:auto;" disabled>'.$vision.'</textarea>';

             echo '<label>Cómo llegar</label>';
              echo '<textarea  rows="3" class="form-control" name="c_llegar"  id="c-llegar" style="resize:none;overflow:auto;" disabled>'.$como.'</textarea>';
              ?>
             
              </br>
              </br>
              <label>Contacto*</label>
              <input type="text" value="<?php echo $contacto?>" maxlength="100" class="form-control" name="contactos" id="contactos" disabled>              
            ...
            <div class="col-md-12" align="center" style="text-align:center">
              ...
              <a href="PED_DIAG_UniversidadesIndex.php"><button type="button" class="btn btn-warning"><i class="fa fa-reply fa-lg"></i>&nbsp;&nbsp;&nbsp;Regresar</button></a>   
            </div>
