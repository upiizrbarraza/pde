      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Detalles de Carreras</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="row" >
          ...
          <form action="" type="post">
            ...
            <div class="col-md-12" align="center" style="text-align:center">
              ...
              <?php                                   
              echo "<a href='PED_DIAG_UniversidadesDetalles.php?idUniversidad=".$Universidad."'><button type='button' class='btn btn-warning'><i class='fa fa-reply fa-lg'></i>&nbsp;&nbsp;&nbsp;Regresar</button></a>";   
              ?>
            </div>
          </form>          
        </div>
