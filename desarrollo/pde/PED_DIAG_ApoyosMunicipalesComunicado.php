  ...
  <div class="nav-backed-header parallax" style="background-image:url(http://www.bolsaplus.com/datos/imagenes/empresa.jpg);">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            <li><a href="index.html">Administraci&oacute;n PDE</a></li>
        ...
        <div class="row">
          <form> 
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> @ss  </td>             
                    <td> 
                      <i class="fa fa-envelope fa-lg" onclick=""></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="col-md-12" align="center" style="text-align:center">
              ...
              <a href="PED_DIAG_SDEIndex.php"><button type="button" class="btn btn-warning"><i class="fa fa-reply fa-lg"></i>&nbsp;&nbsp;&nbsp;Regresar</button></a>   
            </div> 
