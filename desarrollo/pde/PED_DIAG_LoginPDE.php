...
<div class="body"> 
  ...
  <div class="main" role="main">
    <div id="content" class="content full">
      <div class="container">
        <div class="row">          
          <form action="php/login.php" type="post">
          <!-- Start Colum 1 -->  
            <div class="col-md-12"  align="center">     

              <div class="col-md-5 col-md-offset-3" align="center" style="color:#000000;">  
                <h4 class="spaced">Ingresar al PDE</h4></br>
                ...
                <button type="submit" class="btn btn-success" ><i class="fa fa-unlock fa-lg"></i>&nbsp;&nbsp;&nbsp;Ingresar</button>
                </br>
                </br>
                </br>
              </div>                    
